...
#define CERTAIN_INVALID_ACCEPTOR_ID     (uint32_t(-1))
#define CERTAIN_INVALID_SERVER_ID       (uint32_t(-1))
#define CERTAIN_INVALID_PROPOSAL_NUM    (uint32_t(-1))

#define CERTAIN_INVALID_ENTITY_ID       (uint64_t(-1))
#define CERTAIN_INVALID_ENTRY           (uint64_t(-1))

#define CERTAIN_MAX_IO_WORKER_NUM       128
#define CERTAIN_MAX_ENTITY_WORKER_NUM   128
#define CERTAIN_ENTITY_NUM              (1 << 20)

// Required: PB's limited size(60MB default) > MAX_WRITEBATCH_SIZE * 2
//           And a few bytes should be reserved for other fields.
#define CERTAIN_MAX_WRITEBATCH_SIZE     ((21 << 20) - 1000) // 21MB around

#define CERTAIN_MAX_UUID_NUM            50000
#define CERTAIN_UUID_GROUP_NUM          32

#define CERTAIN_MAX_ASYNC_PIPE_NUM      6000
#define CERTAIN_MAX_CONTROL_GROUP_NUM   24

#define CERTAIN_RP_MAGIC_NUM            0x81ac
